const studies = [
  { name: 'Platon', title: 'platon', description: `## Le challenge
  ...
  { name: 'Solane', title: 'solane', description: `## Solane est le premier vendeur de fraises du Poitou-Charentes
  ...
  { name: 'Sedal', title: 'sedal', description: `## Sedal, l'entreprise qui a commencé tout en bas... Et qui est toujours tout en bas
